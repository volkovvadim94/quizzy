...
export const TOKEN_DEFS = [
  ...
  { key: '--quizzy-success', label: 'Success', group: 'Кнопки', type: 'color' },
  ...
  { key: '--quizzy-exit-btn-bg', label: 'Кнопка выхода bg', group: 'Кнопки', type: 'color' },
  { key: '--quizzy-exit-btn-fg', label: 'Кнопка выхода fg', group: 'Кнопки', type: 'color' },
  ...
  { key: '--quizzy-option-bg', label: 'Ответ bg', group: 'Элементы', type: 'color' },
  { key: '--quizzy-option-text', label: 'Ответ текст', group: 'Элементы', type: 'color' },
